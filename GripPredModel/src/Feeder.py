...
class Feeder(torch.utils.data.Dataset):
	...
	def __init__(self, data_list, graph_args={}, train_val_test='train'):
		'''
	...
	def loadDirectData(self):
		[self.all_feature, self.all_adjacency, self.all_mean_xy] = generate_data(self.data_list, pra_is_train=False)
